...
[![Direct APK Download](https://img.shields.io/badge/⚡_Download_APK-v1.0.1-FF6B35?style=for-the-badge&logo=android&logoColor=white)](https://github.com/leo-BWL/MorningPeace/releases/download/v1.0.1/MorningPeace-1.0.1.apk)
...
<p align="center">
  <a href="https://github.com/leo-BWL/MorningPeace/releases/download/v1.0.1/MorningPeace-1.0.1.apk">
    <img src="https://img.shields.io/badge/⚡_Direct_Download_APK-v1.0.1_(Instant)-brightgreen?style=for-the-badge&logo=android&logoColor=white" height="40" alt="Direct Download APK"/>
  </a>
</p>

Click the button above to **directly download the APK file** (`MorningPeace-1.0.1.apk`) straight to your Android device (Android 8.0+ / API 26+).

> [!TIP]
> 1. Once downloaded, tap the APK notification or open it from your **Downloads** folder.
> 2. Tap **Install** (if prompted, allow *"Install unknown apps"* for your browser/file manager).
> 3. You can also view all releases and source code on the [Releases page](https://github.com/leo-BWL/MorningPeace/releases).
...
<p align="center">
  <img src="screenshots/dashboard.jpg" alt="Morning Peace Main Dashboard" width="300" style="border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.3);"/>
  <br/>
  <em>Main Dashboard: Morning Block, Sleep Detection & Quick Focus Controls</em>
</p>
...
flowchart TD
    ...
    B -->|"Yes (Threshold Exceeded)"| C["☀️ Activate Morning Peace Block"]
    B -->|"No"| D["📱 Normal Phone Usage"]
    C --> E["🔒 Calm Overlay on Restricted Apps"]
    E -->|"Timer Expires / Auto-Unlock"| F["✨ Device Restored & Unlocked"]
```

1. **Sleep Detection**: Tracks device idle duration overnight. When you unlock your phone in the morning, Morning Peace automatically activates.
2. **Whitelist Protection**: Essential apps (Phone, Maps, Alarm, Camera) remain accessible without interruption.
3. **Peaceful Focus**: Attempting to open a distracting app brings up a calming countdown screen instead.
4. **Auto Unlock**: When the timer expires, normal device functionality is restored automatically.
...
│   │   └── release.yml             # Automated APK release on version tags
